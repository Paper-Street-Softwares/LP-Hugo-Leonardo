...
import icon2 from "../assets/imgs/icons/icon6.webp";
import icon3 from "../assets/imgs/icons/icon7.webp";
...
export const infos = {
  ...
  instagramProfile: "hugobranco.adv", // Sem o @
  ...
  texts: {
    ...
    features: {
      ...
      card1: {
        ...
        icon: <img src={icon4} alt="" width={42} height={42} />,
      ...
      card2: {
        ...
        icon: <img src={icon1} alt="" width={42} height={42} />,
        buttonLabelModal: "Fale Conosco",
        buttonLabel: "Saiba Mais",
      },
      card3: {
        ...
        icon: <img src={icon2} alt="" width={42} height={42} />,
        buttonLabelModal: "Fale Conosco",
        buttonLabel: "Saiba Mais",
      },
      card4: {
        ...
        icon: <img src={icon3} alt="" width={42} height={42} />,
        buttonLabelModal: "Fale Conosco",
        buttonLabel: "Saiba Mais",
      },
      card5: {
    ...
    blog: {
      ...
      blogLink: "hugobrancoadvocacia.wordpress.com", //sem "https://"
    },
    faq: {
